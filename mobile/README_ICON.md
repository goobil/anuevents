...
Canonical marketing copy (short and long) now lives in `mobile/STORE_COPY.md`. See `mobile/STORE_COPY.md` for short variants, Play Store long description, and suggested App Store text.
