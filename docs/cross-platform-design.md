...
Goal: Provide design and engineering guidance to ship a high-quality cross-platform mobile app (iOS & Android) and later web. Focus on Flutter as the primary frontend technology for consistent UI and single codebase.
